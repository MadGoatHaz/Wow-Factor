...
class ResultsComparator:
    ...
    def load_result(self, filename: str) -> dict[str, Any] | None:
    ...
    def compare_runs(
        ...
        metrics: dict[str, tuple[float | str, float | str, float]] = {}
    ...
    def compare_multiple(
        self,
        files: list[str],
    ) -> dict[tuple[str, str], ComparisonResult | None]:
        """
    ...
    def get_best_run(self) -> str | None:
    ...
    def get_stats_for_run(self, filename: str) -> dict[str, Any] | None:
