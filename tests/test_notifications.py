...
class TestExpiration:
    ...
    def test_not_expired_short_duration(self):
        """Toast with 0s duration is expired immediately."""
    ...
    def test_is_expired_true_after_sleep(self):
        """Toast with 0s duration should expire after sleeping."""
...
# ---------------------------------------------------------------------------
# 10. show() classmethod — verify it exists and is callable
# ---------------------------------------------------------------------------
